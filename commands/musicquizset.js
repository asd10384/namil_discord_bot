...
const { msg_list, msg_np, msg_score } = require('../modules/music/play_msg');
    ...
    async run (client, message, args) {
        ...
        Data.findOne({
            ...
            return message.guild.channels.create(`🎵음악퀴즈`, { // ${client.user.username}-음악퀴즈채널
                ...
                var score = await msg_score(client, message);
                var list = await msg_list(client, message);
                var np = await msg_np(client, message, anser, time);
